...
if os.name == 'nt':
 trip_compile_cmd = 'bash ./infra/development/docker/trip-build.sh'
...
driver_compile_cmd = 'CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o build/trip-service ./services/driver-service/cmd/main.go'
if os.name == 'nt':
 driver_compile_cmd = 'bash ./infra/development/docker/driver-build.sh'
